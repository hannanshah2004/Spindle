  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <h1 className="text-4xl font-bold mb-4">Welcome to Spindle</h1>
        ...
        <SignedOut>
          <div className="bg-yellow-100 p-4 rounded-md border border-yellow-200 text-center max-w-md">
            <p className="text-yellow-700 mb-4">Click the Google button above to sign in</p>
